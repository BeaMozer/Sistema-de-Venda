...
namespace Sistemas_de_Vendas.Controllers
{
    public class AccessLevelsController : Controller
    {
        ...
        public AccessLevelsController(Sistemas_de_VendasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AccessLevelID,Level")] AccessLevel accessLevel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AccessLevelID,Level")] AccessLevel accessLevel)
        {
