...
namespace Sistemas_de_Vendas.Controllers
{
    public class RegistersController : Controller
    {
        ...
        public RegistersController(Sistemas_de_VendasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("RegisterID,UserName,Password")] Register register)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RegisterID,UserName,Password")] Register register)
        {
